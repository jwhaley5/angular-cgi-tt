...
export class MockBackendInterceptor implements HttpInterceptor {
  intercept(
    ...
    function getAssetById() {
      ...
      if (asset != undefined) return ok(asset);
      else return notFound('Asset does not exist!');
    }
    ...
    function addAsset() {
      ...
      newAsset.assetType = assetDto.assetType || undefined;
      newAsset.description = assetDto.description || undefined;
      newAsset.assignedTo = assetDto.assignedTo || undefined;
      newAsset.retired = false;
      newAsset.dateRetired = undefined;
      ...
      localStorage.setItem(
        'assetIdentity',
        (parseInt(assetIdentity) + 1).toString()
      );
    ...
    // helper functions
    function ok(body?: AssetType[] | Asset | undefined) {
